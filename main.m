...
line4 = controller.AddSTRLine(node1,node3);
...
% 
% loadcase1 = controller.AddSTRLoadcase('WL');
% loadcase2 = controller.AddSTRLoadcase('DL');
% loadcase3 = controller.AddSTRLoadcase('ML');
% 
% lineloadconc1 = controller.AddSTRLineLoadConcentrated(loadcase1,-100,0,100,200,500,100,0.4);
% controller.ApplyLoad(lineloadconc1,[2,2,3,5]);
% controller.DeleteLoad(lineloadconc1);
% 
% lineloaddist1 = controller.AddSTRLineLoadDistributed(loadcase2,-100,0,100,200,500,100,0.4,...
...
% 
% 
% nodalload1 = controller.AddSTRNodalLoad(loadcase3,-100,0,100,100,0,100);
% nodalload2 = controller.AddSTRNodalLoad(loadcase3,-100,0,100,100,0,100);
